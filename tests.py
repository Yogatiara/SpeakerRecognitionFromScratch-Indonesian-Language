...
spk2 ,/path/to/utt3
    ...
    def test_get_triplet(self):
        ...
        if myconfig.USE_CUSTOMIZE_DATASETS:
            anchor1_spk = os.path.basename(anchor1).split("_")[0]
            pos1_spk = os.path.basename(pos1).split("_")[0]
            neg1_spk = os.path.basename(neg1).split("_")[0]
            ...
            anchor2_spk = os.path.basename(anchor2).split("_")[0]
            pos2_spk = os.path.basename(pos2).split("_")[0]
            neg2_spk = os.path.basename(neg2).split("_")[0]
...
class TestFeatureExtraction(unittest.TestCase):
    ...
    def test_extract_features(self):
        features = feature_extraction.extract_features(os.path.join(
            myconfig.TEST_DATA_DIR, myconfig.UTT_TEST_FILE_DIRECT))
