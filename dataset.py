...
def get_customize_spk_to_utts(data_dir):
    """Get the dict from speaker to list of utterances for ASR-SIndoDuSC."""
    ...
    for wav_file in wav_files:
        ...
        # print(f"speaker : {spk}")
        if spk not in spk_to_utts:
            spk_to_utts[spk] = [wav_file]
        else:
            spk_to_utts[spk].append(wav_file)
